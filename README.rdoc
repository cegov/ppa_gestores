...
BUG HOME: puxar cursos na ordem reversa
BUG HOME: puxar notícias na ordem reversa

OK margin-top 20px no footer

hr apos noticia em destaque

tirar borda da caixa de noticias/etc (flat)

linkar a caixa de notícias e fazer efeito hover nela e não no link

letras menu em bold

header azul (claro / escuro)
