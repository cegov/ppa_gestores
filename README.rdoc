...
rails g migration change_data_types_for_faq
...
Create model and database:
	...
	created_on:date
	updated_on:date	
Create a gem to encapsulate the code
Create a rails engine refinery-course
Translate the en.yml file
Create a tab on the menu
Override the layout to show only fields with meaning to the user
Editar index, show nas views do dir refinery e editar _form das views de admin

rails g refinery:engine faq refinery_user_id:integer question:string answer:string is_published:boolean
