...
mudar a cor de page title, é um link agora, tem que mudar a cor de hover na mixin 
achar uma forma de fazer os links das páginas aparecerem automaticamente no menu
