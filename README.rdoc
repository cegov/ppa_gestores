...
criar checkbox para fazer esse toggle na view

tirar logo_subordination
título: portal / ppa municipal
fontes 15px;
line-height: 150% para p
h1-h6: 110%
menu não arredondando, mais espaçamento entre os itens do menu
