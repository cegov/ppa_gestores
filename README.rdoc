...
rails g refinery:engine newsarticle refinery_user_id:integer headline:string lead:string byline:string photo:image story:text event_date:date is_published:boolean
