...
adequar CSS/less com o override do Twitter bootstrap: 
  reescrever o html do body#content para integrar Twitter bootstrap e Refinery CMS
  reescrever o html do body#side_bar para integrar Twitter bootstrap e Refinery CMS
