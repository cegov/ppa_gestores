...
ajustar a lista de cursos na view de cursos

programar o link de acessibilidade: 
copiar essa página: http://www.brasil.gov.br/acessibilidade
programar os atalhos do teclado para que a explicação acima funcione

tratar campos null e blank nas views show de newsarticles e courses
...
fazer a relação dos recursos dos plugins e a class Refinery_User
vide:
